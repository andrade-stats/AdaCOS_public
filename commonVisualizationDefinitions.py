...
def getAllMethodNames(dataName, FEATURE_SELECTION_METHOD, classificationModelName, COST_TYPE, AdaptGBRT_classifier = None):
    ...
    if COST_TYPE == "recall":
        allMethodNamesStem = ["getOptimalSequence_dynamic_BR_noUnlabeledData_" + FEATURE_SELECTION_METHOD, "getOptimalSequence_static_" + FEATURE_SELECTION_METHOD, "getOptimalSequence_fullModel"]
