...
flags.DEFINE_string(
    "model_dir",
    default=os.path.join(os.getenv("TEST_TMPDIR", "/export/home/s-andrade/eclipseWorkspaceDynamic/DynamicCovariateSelection/tmp"),
                         "logistic_regression/"),
...
def main(argv):
    ...
    if tf.io.gfile.exists(FLAGS.model_dir):
        tf.logging.warning("Warning: deleting old log directory at {}".format(FLAGS.model_dir))
    ...
    with tf.Session() as sess:
        ...
        print("posterior weights = ", w_draw.shape)
        print("posterior bias = ", b_draw.shape)
        
        print("posterior weights = ", w_draw)
        # assert(False)
